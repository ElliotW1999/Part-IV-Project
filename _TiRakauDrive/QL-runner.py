...
def run():
    ...
    while step < 600:
        ...
        Phase_D_4220_Density = traci.lane.getLastStepVehicleNumber("gneE73_0") + traci.lane.getLastStepVehicleNumber("gneE73_1") + traci.lane.getLastStepVehicleNumber("gneE10_0")
