...
SARS = SARSsimplified
# add an unreachable transition so that the iterator SARSNumber doesnt point to a non existent SARS
...
#updateVal = open("updateValues.csv", "a+")
#for val in updateValues:
#    updateVal.write(str(val) + "\n")
#updateVal.close()
