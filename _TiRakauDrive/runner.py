...
def generate_routefile():
    ...
    with open("data/osm.rou.xml", "w") as routes:
        ...
        <route id="south4220" edges="gneE10 gneE11 624439643 66457665 665260214#0" />
        ...
        <route id="r4220s4221e" edges="gneE10 28641508 620377518 159605088 7637388#0 7637388#1 28573015#0 28573015#1 28573015#2 28573015#3 28573015#4 28573015#5 28573015#6" />""", file=routes)
        vehNr = 0
